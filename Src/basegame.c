...
extern Config config;																// To use Resolution Scaling Settings
Cell grid[SOKOBAN_GRID_ROWS][SOKOBAN_GRID_COLS];									// Game Array of Struct for Cells
Move moves[MOVE_MAX][SOKOBAN_GRID_ROWS][SOKOBAN_GRID_COLS];							// Array of Struct for Moves (Save Previous Move)
Customer customer[CUSTOMER_MAX];													// Array of Stuct for Customer
Teleporter teleporters[TELEPORTER_NUMBER];											// Array of Struct for Teleporter
