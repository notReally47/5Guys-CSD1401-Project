...
void drawGIF(CP_Image img, float x, float y, float w, float h, int flip, static const float frame_dimension, static float timeElapsed, static int imageIndex, const int totalFrames, const int numRows);
